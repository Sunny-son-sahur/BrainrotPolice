...
function env.getgitpath(where)
    local mainBuild = "https://raw.githubusercontent.com/Sunny-son-sahur/BrainrotPolice/main/"
    if where == "src" then
...
if queue_on_teleport then
    queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/Sunny-son-sahur/BrainrotPolice/main/src/init.lua"))()')
end